      ...
      extraConfig = ''
        ...
        return 200 '<!DOCTYPE html>
          ...
          <head>
              ...
              <style>
                  body { margin:0; background:#050505; color:#00ff41;
                  ...
                  body::before { content:" "; position:absolute;
                         ...
                         background-size:100% 2px,3px 100%; z-index:2; pointer-events:none; }
                  .container { text-align:center; border:2px solid #00ff41; padding:4rem;
                         box-shadow:0 0 20px #00ff41,inset 0 0 20px #00ff41;
                         position:relative; z-index:1; }
                  h1 { font-size:3.5rem; margin:0; text-transform:uppercase;
                         letter-spacing:10px; text-shadow:0 0 10px #00ff41; }
                  p  { margin-top:2rem; font-size:1.2rem; letter-spacing:2px; opacity:.8; }
                  .flicker { animation:pulse 2s infinite; }
